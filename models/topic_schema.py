...
class Topic(BaseModel):
    ...
    def to_legacy_dict(self) -> dict:
        ...
        return {
            ...
            "exposure_specific": self.exposure_X.specific_variable,
            "exposure_family": self.exposure_X.family.value,
            "exposure_proxy": self.exposure_X.measurement_proxy,
            "outcome_variable": self.outcome_Y.specific_variable,
            "outcome_specific": self.outcome_Y.specific_variable,
            "outcome_family": self.outcome_Y.family.value,
            "outcome_proxy": self.outcome_Y.measurement_proxy,
            "geography": self.spatial_scope.geography,
            "spatial_unit": self.spatial_scope.spatial_unit,
            "method": self.identification.primary.value,
            "key_threats": list(self.identification.key_threats),
            "mitigations": dict(self.identification.mitigations),
